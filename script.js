...
const symbolseCheck = document.querySelector("#symbols");
...
function setIndicator(color) {
  ...
  indicator.style.boxShadow = `1px 1px 15px 3px ${color}`;
}
...
function calcStrength() {
  ...
  if (symbolseCheck.checked) hasSym = true;
...
generateBtn.addEventListener("click", () => {
  ...
  if (symbolseCheck.checked) funArr.push(generateSymbol);
